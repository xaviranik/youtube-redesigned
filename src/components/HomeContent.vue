<template>
  <div class="col-span-10 py-24 overflow-y-auto" :class="sidebarIsOpen ? 'col-span-10' : 'col-span-12'">
    <div class="grid grid-cols-4 gap-6 px-6" :class="sidebarIsOpen ? 'grid-cols-4' : 'grid-cols-5'">
