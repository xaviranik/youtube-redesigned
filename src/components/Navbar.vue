    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        <input
          type="text"
          placeholder="Search"
          class="border rounded-lg rounded-r-none placeholder-gray-600 placeholder-opacity-50 font-base border-gray-300 focus:outline-none transition duration-300 focus:border-gray-400 px-3 py-1 w-128"
        />
        <button
          class="flex bg-gray-100 rounded-lg rounded-l-none border-t border-r border-b border-gray-300 hover:bg-gray-200 py-1 px-5"
        >
      ...
      <div>
        <div class="flex items-center">
          <button class="flex focus:outline-none px-3">
            <span class="material-icons text-gray-600">video_call</span>
          </button>
          <button class="flex focus:outline-none px-3">
